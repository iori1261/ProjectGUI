...
public class VendingView extends JFrame {
    ...
    public VendingView(String title, Controller ctrl, List<DrinkData> drinks) {
        ...
        price1Lbl = new JLabel("¥" + drinks.get(0).getPrice());
        price2Lbl = new JLabel("¥" + drinks.get(1).getPrice());
        price3Lbl = new JLabel("¥" + drinks.get(2).getPrice());
        ...
        manageInventoryBtn = new JButton("品揃え管理");

        Image = new ImageIcon("src/task_final03/image.jpg");
        ...
        manageInventoryBtn.setBounds(140, 370, 150, 20);
        ...
        manageInventoryBtn.setActionCommand(ctrl.MANAGE_INVENTORY);
        manageInventoryBtn.addActionListener(ctrl);
    }
    ...
    public void updateDrinks(List<DrinkData> drinks) {
        this.drinks = drinks;
        name1Lbl.setText(drinks.get(0).getName());
        name2Lbl.setText(drinks.get(1).getName());
        name3Lbl.setText(drinks.get(2).getName());

        price1Lbl.setText("¥" + drinks.get(0).getPrice());
        price2Lbl.setText("¥" + drinks.get(1).getPrice());
        price3Lbl.setText("¥" + drinks.get(2).getPrice());
    }
}
