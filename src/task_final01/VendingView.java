...
public class VendingView extends JFrame {
	...
	public VendingView(String title, Controller ctrl, List<DrinkData> drinks) {
		...
		Image = new ImageIcon("src/task_final01/image.jpg");
		...
		buy1Btn.setBounds(20,310,80,20);
		buy2Btn.setBounds(180,310,80,20);
		buy3Btn.setBounds(345,310,80,20);
	...
	public int getDrinkIndex(int buttonIndex) {
		if (buttonIndex >= 0 && buttonIndex < drinks.size()) {
			return buttonIndex;
		}
		return -1;
	}
